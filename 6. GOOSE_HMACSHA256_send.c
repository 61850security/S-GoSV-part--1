...
char length_2=0x91;
char resrv1_1=0x00; 		     
char resrv1_2=0x26; /* the length of the hash generated is 32 + extension field length 6 bytes)=38 bytes */                  
char resrv2_1=0xF2; 		     
char resrv2_2=0x32;             
...
char SEQUENCE_length=0x24; //length of the extension 36 => 0x24
char Auth_value_tag=0xA4;  // Authentication value tag 0xA4. 
char Auth_length=0x22;  // 32 + 2 = 34 in hex 0x22
char mac_tag=0x85;
char mac_length=0x20;

unsigned char hash_val[32]= 
	{
		0x43, 0xaa, 0xb4, 0xd9, 0x45, 0x57, 0xe6, 0xc8, 0x05, 0xb1, 0xb0, 0x28, 0x2d, 0x67, 0xb7, 0xc8, 
                0x0e, 0x32, 0x35, 0x7d, 0x87, 0x80, 0x72, 0x06, 0x81, 0xcb, 0x30, 0x0e, 0x76, 0x7c, 0x00, 0xeb 	
	}; 
...
int main(int argc, char *argv[])
{
	...
	sendbuf[tx_len++] = SEQUENCE_tag; // Sec Extention Tag. 1 byte 0x30
	sendbuf[tx_len++] = SEQUENCE_length; //length of the extension 36 => 0x24
	sendbuf[tx_len++] = Auth_value_tag;  // Authentication value tag 0xA4. 
	sendbuf[tx_len++] = Auth_length;  // 32 + 2 = 34 in hex 0x22
